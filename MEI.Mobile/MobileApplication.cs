...
namespace MEI.Mobile {
    ...
    public partial class MEIMobileApplication : MobileApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Mobile.SystemModule.SystemMobileModule module2;
        private MEI.Module.MEIModule module3;
        private MEI.Module.Mobile.MEIMobileModule module4;
        ...
        protected override void SetLogonParametersForUIBuilder(object logonParameters) {
            ...
            ((AuthenticationStandardLogonParameters)logonParameters).Password = "skadmin@2019";
        }
        ...
        private void MEIMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new MEI.Module.MEIModule();
            this.module4 = new MEI.Module.Mobile.MEIMobileModule();
            ...
            this.securityStrategyComplex1.RoleType = typeof(MEI.Module.BusinessObjects.UserAccessRole);
            this.securityStrategyComplex1.UserType = typeof(MEI.Module.BusinessObjects.UserAccess);
            // 
            ...
            // 
            // MEIMobileApplication
            // 
            this.ApplicationName = "MEI";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.MEIMobileApplication_DatabaseVersionMismatch);
